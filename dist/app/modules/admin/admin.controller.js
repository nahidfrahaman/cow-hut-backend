...
const createAdmin = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const results = yield admin_service_1.AdminService.createAdmin(createdAdminData);
...
const login = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const results = yield admin_service_1.AdminService.login(loginData);
...
const refreshToken = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const results = yield admin_service_1.AdminService.refreshToken(refreshToken);
    (0, sendeResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
        message: 'admin login successfuly',
