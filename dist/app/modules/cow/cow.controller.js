...
const getCows = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const results = yield cow_service_1.CowService.getCows(
      filtersData,
      paginationOption
    );
    (0, sendeResponse_1.default)(res, {
...
const updateCow = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const results = yield cow_service_1.CowService.updateCow(id, updatedData);
    (0, sendeResponse_1.default)(res, {
      statusCode: http_status_codes_1.StatusCodes.OK,
      success: true,
...
const deleteCow = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const results = yield cow_service_1.CowService.deleteCow(id);
    (0, sendeResponse_1.default)(res, {
      statusCode: http_status_codes_1.StatusCodes.OK,
      success: true,
