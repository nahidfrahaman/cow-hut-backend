...
const getCows = (filters, paginationOption) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateCow = (id, updatedData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const results = yield cow_model_1.Cow.findByIdAndUpdate(id, updatedData, {
      new: true,
    });
    return results;
  });
...
const deleteCow = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const results = yield cow_model_1.Cow.findByIdAndDelete(id);
    return results;
  });
exports.CowService = {
  createCow,
