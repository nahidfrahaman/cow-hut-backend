...
const getAllUser = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      user_constant_1.userSearchabeFields
    );
    console.log(filters);
    const paginationOption = (0, pick_1.default)(
      req.query,
      user_constant_1.paginationOptions
    );
    // const filteredData = pick(req.body, ['role', 'address', 'budget']);
    const results = yield user_service_1.UserService.getAllUser(
      filters,
      paginationOption
    );
...
const updateUser = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const results = yield user_service_1.UserService.updateUser(
      id,
      updatedData
    );
    (0, sendeResponse_1.default)(res, {
...
const userDelete = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
