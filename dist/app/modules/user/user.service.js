...
const getAllUser = (filters, paginationOption) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const results = yield user_model_1.User.find(whereCondition)
      .skip(skip)
      .limit(limit);
...
const updateUser = (id, updatedData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { name } = updatedData,
      userUpdatedData = __rest(updatedData, ['name']);
    ...
    const results = yield user_model_1.User.findOneAndUpdate(
      { id },
      updatedStudentData,
      {
        new: true,
...
const userDelete = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const results = yield user_model_1.User.findByIdAndDelete([id], {
        session,
      });
      finalResults = results;
      const deleteAuthUser = yield auth_model_1.AuthUser.findOneAndDelete(
        [{ id: id }],
        {
          session,
        }
